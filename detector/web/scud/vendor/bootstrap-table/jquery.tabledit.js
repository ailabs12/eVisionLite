    ...
    $.fn.Tabledit = function(options) {
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        var toolbar = '<div class="tabledit-toolbar ' + settings.toolbarClass + '" style="text-align: left;justify-content: center;">\n\
                        ...
                        $table.find('tr:gt(0)').append('<td style="white-space: nowrap; width: 148px;">' + toolbar + '</td>');
        ...
        function ajax(action)
        {
            ...
            var jqXHR = $.get(settings.url, serialize, function(data, textStatus, jqXHR) {
                ...
                settings.onSuccess(data, textStatus, jqXHR, action);
            }, 'json');
